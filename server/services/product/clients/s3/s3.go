...
type S3ClientInterface interface {
	UploadFile(ctx context.Context, filename string, file io.Reader) (err error)
...
func (client *S3Client) UploadFile(ctx context.Context, filename string, file io.Reader) (err error) {
